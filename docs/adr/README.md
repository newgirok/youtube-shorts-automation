...
| [ADR 004](./004-render-engine.md) | 렌더링 엔진 — FFmpeg | Phase 1~4는 FFmpeg, Phase 5부터 Remotion으로 전환 예정 | Accepted |
| [ADR 005](./005-gemini-flash.md) | AI 모델 — Gemini 2.0 Flash | 무료 1,500 req/day, 한국어 쇼츠 스크립트 품질 합격 | Accepted |
...
| [ADR 008](./008-whisper-model.md) | STT 모델 — faster-whisper large-v3 | 한국어 인식률 93%, 메모리 3GB로 Lambda 불가 → Fargate 전용 | Accepted |
