...
'현재 거의 대한민국 전체와 맞짱 뜨고 있다는 삼성전자 노조 — 지금 이재용 회장의 머리를 숙이게 만들 정도로 그 위세가 아주 대단하다고 하는데, 심지어 이번에 창사 이래 첫 총파업을 예고하며 반도체 라인 전체를 멈춰 버리겠다면서 지금 대한민국 경제를 인질삼아 자신들의 요구를 관철하려 삼성을 거세게 압박하고 있었다고 함. 결국 보다못한 이재용 회장이 직접 머리 숙여 대국민 사과문을 발표했는데 그걸 본 대한민국 국민들과 주주들이 지금 진짜 개빡친 상황이라고. 하지만 이재용 회장의 머리를 단번에 숙이게 만들 정도로 강성했던 노조의 동력이 지금 슬슬 꺾이기 시작한 상황이라고 함. 먼저 이번에 법원이 파업 중에도 핵심 생산 시설을 평상시와 동일한 수준으로 가동해야 한다고 명령하면서 이를 어기고 시설 가동을 방해할 경우 노조는 하루 1억 원, 노조 간부는 하루 1천만 원씩 지급해야 한다며 사실상 파업의 효과를 법적으로 제한해 버린 상황이라고. 막다른 길에 몰린 노조가 플랜B를 거론하고 있지만 이 역시 불법 투쟁으로 간주될 소지가 크기 때문에 정부의 긴급 조정권 발동 사유가 될 수 있다는 분석이라고. 여러분은 누가 문제라고 봅니까?'
